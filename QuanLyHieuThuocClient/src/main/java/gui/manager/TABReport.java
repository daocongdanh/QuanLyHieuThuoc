...
public class TABReport extends javax.swing.JPanel {
    ...
    public TABReport() throws RemoteException {
    ...
    private void fillTable() throws RemoteException {
        ...
        Report r = reportBUS.getAllReportByTime(LocalDate.now().atStartOfDay(), LocalDate.now().atTime(23, 59, 59, 9999999), (String) comboboxType.getSelectedItem());
        fillContent(r);
    }
