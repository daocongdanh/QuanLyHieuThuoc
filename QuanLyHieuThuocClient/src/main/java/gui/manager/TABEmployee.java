...
public class TABEmployee extends javax.swing.JPanel {
    ...
    private void fillTable() throws RemoteException {
        ...
        List<Employee> employees = employeeBUS.getAllEmployee();
    ...
    private void fillContent(List<Employee> employees) {
        ...
        for (Employee employee : employees) {
            tableDesign.getModelTable().addRow(new Object[]{employee.getEmployeeId(), employee.getName(), 
            employee.getEmail(), employee.getPhone(), employee.getAddress(), null});
        }
    }
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (selectedRow < 0) {
            ...
            txtEmployeeName.setText((String) tableDesign.getTable().getValueAt(selectedRow, 1));
            txtEmployeeAddress.setText((String) tableDesign.getTable().getValueAt(selectedRow, 4));
            txtEmployeeEmail.setText((String) tableDesign.getTable().getValueAt(selectedRow, 2));
            txtEmployeePhone.setText((String) tableDesign.getTable().getValueAt(selectedRow, 3));
    ...
    private void btnAddNewEmployeeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddNewEmployeeActionPerformed
        ...
        try {
            ...
            Account acc = new Account(null, passHash, emp);
            acc.setEmployee(emp);
    ...
    private void btnUpdateEmployeeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateEmployeeActionPerformed
        ...
        try {
            Employee employee = employeeBUS.getEmployeeId(employeeIdUpdate);
