 ...
 * @author Hoang
 */
public class TABStaffSupplier extends javax.swing.JPanel {

    private final SupplierBUS supplierBUS;
    private TableDesign tableDesign;
    private String supplierEdit;

    public TABStaffSupplier() {
    ...
    if (selectedRow != -1) {
        ...
        modelSupplierEdit.setSize(1050, 580);
        modelSupplierEdit.setTitle("Sửa thông tin nhà cung cấp");
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        // TODO add your handling code here:
        modelSupplierAdd.setSize(1050, 580);
        modelSupplierAdd.setTitle("Thêm nhà cung cấp");
