 ...
 * @author Hoang
 */
public class PanelActionOnlyDelete extends javax.swing.JPanel {

    /**
     * Creates new form PanelAction
     */
    public PanelActionOnlyDelete() {
        initComponents();
    }
    
     public void initEvent(TableActionEventOnlyDelete event, int row) {
    ...
    private void initComponents() {
        ...
        edit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/delete.png"))); // NOI18N
