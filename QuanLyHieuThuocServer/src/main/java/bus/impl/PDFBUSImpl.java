...
import entity.*;
import util.CustomDashedLineSeparator;
...
public class PDFBUSImpl extends UnicastRemoteObject implements PDFBUS {
    ...
    public PDFBUSImpl() throws RemoteException {
        super();
    }

    public byte[] generatePDF(Order order) throws IOException, DocumentException, RemoteException {
...
//        deletePDF(path);
    ...
    public byte[] generatePDFReturn(ReturnOrder returnOrder) throws IOException, DocumentException,RemoteException {
...
//        deletePDF(path);
    ...
    public byte[] generatePDFPurchase(PurchaseOrder purchaseOrder) throws IOException, DocumentException, RemoteException {
...
//        deletePDF(path);
    ...
    public void deletePDF(String path) throws RemoteException {
